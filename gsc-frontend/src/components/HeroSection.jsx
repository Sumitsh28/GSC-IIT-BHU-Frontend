  ...
  return (
   ...
   <div className=" sm:bg-[url('/assets/HeroSectionBluePattern.svg')] bg-no-repeat lg:bg-right-bottom-lg md:bg-right-bottom-md sm:bg-right-bottom-sm lg:bg-[length:300px_300px] md:bg-[length:250px_250px] sm:bg-[length:200px_200px] bg-[length:0px_0px] ">
        ...
        <div className='flex flex-col items-start justify-center lexend my-[30px]'>
            <p className='text-[20px] md:text-[40px] text-white font-bold font-lexend sm:text-[30px]'>GAMES & SPORTS</p>
            <p className='text-[20px] md:text-[40px] text-white font-bold font-lexend sm:text-[30px]'>COUNCIL</p>
            <p className='text-[20px] md:text-[40px] text-white font-bold font-lexend sm:text-[30px]'>IIT (BHU) VARANASI</p>
        ...
        <div className='w-[100%] lg:w-[55%] md:w-[65%] sm:w-[70%] lg:mt-[100px] md:mt-[50px] sm:mt-[30px] '><Carousel items={items} /></div>
        </div>
